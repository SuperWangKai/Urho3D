...
void ASRegisterGenerated_Members_F(asIScriptEngine* engine)
{
    ...
    engine->RegisterObjectMethod("FileWatcher", "bool StartWatching(const String&in, bool, bool)", asMETHODPR(FileWatcher, StartWatching, (const String&, bool, bool), bool), asCALL_THISCALL);
