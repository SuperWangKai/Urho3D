...
void ASRegisterGenerated_Members_R(asIScriptEngine* engine)
{
    ...
    engine->RegisterObjectMethod("ResourceCache", "void SetAutoReloadResources(bool, bool)", asMETHODPR(ResourceCache, SetAutoReloadResources, (bool, bool), void), asCALL_THISCALL);
    engine->RegisterObjectMethod("ResourceCache", "void set_autoReloadResources(bool, bool)", asMETHODPR(ResourceCache, SetAutoReloadResources, (bool, bool), void), asCALL_THISCALL);
    // void Object::SetBlockEvents(bool block) | File: ../Core/Object.h
